...
//   const navigate = useNavigate();
 ...
 const handleDelete = async (event) => {
  ...
  const getGifByCount = () => {
    if(postCount === 0) return "/public/imagenes/colibri.jpg";
    if(postCount <= 3) return "/public/imagenes/gorrion.jpg";
    if(postCount <= 6) return "/public/imagenes/paloma.jpg";
    if(postCount <= 9) return "/public/imagenes/aguila.jpg";
    return "/public/imagenes/avestruz.jpg"; //+de 10 publicaciones asies
  }
